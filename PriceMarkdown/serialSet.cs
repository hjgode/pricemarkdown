    ...
    class serialSet : IDisposable
    {
        ...
        private int regReadInt(string sValuename)
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in regReadInt for '" + _regSubKey + "'/" + sValuename + ". " + x.Message);
            }
            return -1;
        }
        private uint regReadUInt(string sValuename)
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in regReadUInt for '" + _regSubKey + "'/" + sValuename + ". " + x.Message);
            }
            return 0;
        }
        private bool regWriteInt(string sValuename, uint i)
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in regWriteUInt for '" + _regSubKey + "'/" + sValuename + ". " + x.Message);
            }
            return false;
        }
        private bool regWriteInt(string sValuename, int i)
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in regWriteInt for '" + _regSubKey + "'/" + sValuename + ". " + x.Message);
            }
            return false;
        }
        ...
        private string regReadString(string sValuename)
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in regReadStrings for '" + _regSubKey + "'/" + sValuename + ". " + x.Message);
            }
            return null;
        }
        ...
        private bool regWriteString(string sValuename, string s)
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in regWriteStrings for '" + _regSubKey + "'. " + x.Message);
                return false;
            }
        }
        ...
        private bool regOpenKey()
        {
            ...
            catch (Exception x)
            {
                ...
                PriceMarkdown.Helpers.logError("Exception in OpenSubKey/CreateSubKey for '" + _regSubKey + "'. " + x.Message);
            }
            return false;
        }
        private void regCloseKey()
        {
            if (_regKey != null)
            {
                ...
                catch (Exception x)
                {
                    ...
                    PriceMarkdown.Helpers.logError("Exception in CloseKey for '" + _regSubKey + "'. " + x.Message);
                }
            }
        }
#endregion
